/* ==========================================================================
   mindfulmarkus — Tailwind preset
   For any Tailwind project. In your tailwind.config:
   ...
   Gives you the same utilities the website uses: text-forest, bg-clay,
   rounded-xl2, shadow-card, font-serif, tracking-widest2, animate-fade-up, etc.
   ========================================================================== */
  ...
  theme: {
    extend: {
      colors: {
        ...
        sand: { DEFAULT: '#E7D9C2', light: '#F1E8D8' },
        cream: '#F7F1E6',
        parchment: '#F2E9D8',
        bark: '#3A2E26',
        ink: '#2B241E',
      ...
      animation: { 'fade-up': 'fade-up 0.9s ease-out both' },
    },
  },
}
